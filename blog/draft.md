# How To Use The Airtable API And The Shotstack API To Build An Automated Video Generator
...
Go back to your browser, and download the following [CSV file](./assets/recipes.csv) containing the data that you are going to use to populate your table.
...
The template that you are going to use generate videos can be downloaded in the following [link](./assets/template.json). Download the file and store it in your project's root directory under the name `template.json`.
